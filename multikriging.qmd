...
m_error
#saveRDS(m_error, here("1_data", "m_krige_error.RDS"))
...
rmse_combined <- cowplot::plot_grid(
  p_error_list[[1]][[1]],
  p_error_list[[1]][[2]], 
  labels = c("Train", "Test")) 

rmse_combined
#saveRDS(combined, here("1_data", "kriging_combined_error.rds"))
#saveRDS(rmse_combined, here("1_data", "kriging_rmse_combined.rds"))
```
